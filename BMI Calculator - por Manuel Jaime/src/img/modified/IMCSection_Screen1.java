...
public class IMCSection_Screen1 extends javax.swing.JFrame {

    /**
     * Creates new form IMCSection_Screen
     */
    public IMCSection_Screen1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        clean_user_data_btn.setText("LIMPAR DADOS DO USUÁRIO");
    ...
    private void calcIMC_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcIMC_btnActionPerformed
        ...
        if(Double.isNaN(IMC ) || idade >= 100 || name_input.getText().equals("") || age_input.getText().equals("") || altura_input.getText().equals("") || peso_input.getText().equals("") || IMCResult_label.getText().equals("") || IMC_Avaluation_label.getText().equals("")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IMCSection_Screen1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IMCSection_Screen1().setVisible(true);
            }
        });
    }
